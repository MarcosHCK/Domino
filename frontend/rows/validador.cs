...
{
  [GLib.TypeName ("DominoListBoxRow+validador")]
  [Gtk.Template (ResourceName = "rows/validador.ui")]
  public sealed class validador : Gtk.Grid, IListBoxRow<(int, int[])>
  {
    [Gtk.Builder.Object]
    ...
    [GLib.TypeName ("DominoListBoxRow+validador2")]
    [Gtk.Template (ResourceName = "rows/validador2.ui")]
